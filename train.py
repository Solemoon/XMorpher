...
class RSeg(object):
    def __init__(self, k=0, n_channels=1, n_classes=8, lr=1e-4, epoches=400, iters=200, batch_size=1, model_name='XMorpher_heart_0'):
        ...
        self.iters=iters
        train_labeled_unlabeled_dir = '/media/E/yt/RST/data/heart_CT_5/train_labeled_unlabeled'
        train_unlabeled_unlabeled_dir = '/media/E/yt/RST/data/heart_CT_5/train_unlabeled_unlabeled'
        test_labeled_labeled_dir = '/media/E/yt/RST/data/heart_CT_5/test'
